...
MergeDiff.prototype.delete = function (path) {
    ...
    this._mergeObject(this.object, utils.wrapByPath(this.options.deleteKeyword, path), '', this.options, 0);
...
MergeDiff.prototype._mergeObject = function (source, delta, path, options, level, override) {
    ...
    if (override) {
        ...
        levelDiffs = this._detectDeletionsAtLevel(source, delta, levelDiffs, path, options, isSourceArray);
    }
